...
try:
    ...
    # st.secrets raises StreamlitSecretNotFoundError (instead of returning
    # None) when no secrets.toml exists at all -- which is the normal case
    # for a fresh local checkout of this app.
    api_key = None
if not api_key:
