...
SECTIONS = {
    ...
    "ROBOTICS": {
        ...
        "layers": {
            ...
            "Layer 2: Sense, Control & Digital Twin": {
                "weight": 0.20,
                "tickers": ["OMRNY", "CGNX", "AME", "DSY.PA"],
                "core_eligible": ["AME", "CGNX"],
                "protocol": "Machine vision (Cognex), industrial automation/sensors (Omron), "
                "precision measurement/testing (AMETEK), and 3D design/digital twin software (Dassault).",
            },
            ...
            "Layer 4: EMS & Integration": {
                ...
                "protocol": "Electronics Manufacturing Services (Flex, Jabil) and industrial connectivity/interconnects "
                "(TE Connectivity - TEL). The 'hands' that build and wire the factory.",
            },
        },
    },
    # ----------------------------------
...
def __getattr__(name):
    ...
    raise AttributeError(f"module 'structural_grid' has no attribute {name!r}.")
